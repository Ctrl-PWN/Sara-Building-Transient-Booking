...
function DialogContent({
  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Popup
        className={cn(
          'fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-background p-6 shadow-lg data-[ending-style]:fade-out data-[starting-style]:fade-in data-[ending-style]:zoom-out data-[starting-style]:zoom-in data-[ending-style]:duration-150 data-[starting-style]:duration-150',
          className,
        )}
        {...props}
      >
