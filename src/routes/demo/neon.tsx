  ...
  return (
    <div className="page-wrap px-4 py-12 text-center">
      <div className="block-card p-8 max-w-xl mx-auto space-y-6">
        ...
        <div className="p-4 border-2 border-[var(--charcoal)] rounded-[1rem] bg-[var(--surface-container-low)] text-left">
          <h3 className="font-data text-xs font-bold uppercase tracking-[0.05em] text-[var(--on-surface)] mb-4">
            Required Steps to Fix:
          </h3>
          <ul className="space-y-3 list-none font-body text-sm text-[var(--on-surface-variant)]">
            <li className="flex items-start gap-3">
              <span className="flex items-center justify-center w-7 h-7 rounded-[1rem] border-2 border-[var(--charcoal)] bg-[var(--primary)] text-[var(--on-primary)] font-data text-xs font-bold shrink-0">
                1
              </span>
              <span>
                Use the <code className="font-data text-xs">db/init.sql</code> file to create the database
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex items-center justify-center w-7 h-7 rounded-[1rem] border-2 border-[var(--charcoal)] bg-[var(--primary)] text-[var(--on-primary)] font-data text-xs font-bold shrink-0">
              ...
              <span>
                Set the <code className="font-data text-xs">DATABASE_URL</code> environment variable to your Neon connection string
              </span>
            </li>
          </ul>
        </div>
